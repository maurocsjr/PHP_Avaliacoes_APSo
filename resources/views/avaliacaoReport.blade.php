    ...
    <div class="content">
        ...
        <tfoot>
            <tr>
                ...
                <td colspan="1" >{{$secao->Nota_Final}} / {{$secao->Soma_Peso_Item}} ou {{round((($secao->Nota_Final / $secao->Soma_Peso_Item) * 100), 0)}} %</td>
            </tr>
        </tfoot>
        </table>
        @endforeach
        ...
        <tfoot>
            <tr>
                ...
                <td colspan="1" >{{round((($secoesAvaliacao->sum('Porcentagem') / $secoesAvaliacao->count())  * 100), 0)}} %</td>
            </tr>
        </tfoot>
        </table>
        <div>
        ...
        @endforeach
        @else
        <div style="font-size: 12px;">Nenhum feedback registrado.</div>
        @endif
        </div>
